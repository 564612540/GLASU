...
python3 ./GFL_standalone.py --log_dir "./log" --tag "DistV2" --num_clients 3 --hidden_size 192 --dropout 0.2 --global_iter 32 --local_iter 32 --lr 0.02 --gnn_size 2_2 --expand_size 2 --method avg --print_freq 1 --residual --batch_size 16 --mu 0.5 --momentum 0.0  --dataset Cora --num_classes 7

python3 ./GFL_standalone.py --log_dir "./log" --tag "DistV2" --num_clients 3 --hidden_size 256 --dropout 0.2 --global_iter 32 --local_iter 32 --lr 0.02 --gnn_size 2_2 --expand_size 2 --method avg --print_freq 1 --residual  --batch_size 16 --mu 0.5 --momentum 0.0 --dataset CiteSeer --num_classes 6
